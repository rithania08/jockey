    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>admin/" class="logo">
          ...
          <span class="logo-mini"><b>CG</b>A</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>CGA</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Store #<?php echo $this->common_model->get_record("tbl_stores", "id = '" . $_SESSION['store_id'] . "'", "store_id"); ?></small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
				...
				<li class="treeview">
				  <a href="<?php echo base_url(); ?>admin/bills">
					<i class="fa fa-book"></i> <span>Bills</span></i>
				  </a>
				</li>
				<li class="treeview">
				  <a href="<?php echo base_url(); ?>admin/salenote">
					<i class="fa fa-money"></i> <span>Sale Note</span></i>
				  </a>
				</li>
				<?php if($role == ROLE_ADMIN || $role == ROLE_SUPER_ADMIN || $role == ROLE_MANAGER): ?>
					<li class="treeview">
          ...
          <li class="treeview">
            <a href="<?=base_url()?>admin/salenote-entry-access" >
            <i class="fa fa-key"></i>
            <span>Salenote Entry Access</span>
            </a>
          </li> 
				<?php
				}
