...
class BaseController extends CI_Controller {
	 ...
	 */
	function loadThis() {
		$this->global ['pageTitle'] = "Mimaa's Marketplace : Access Denied";
    ...
    function loadPage($viewName = "", $Info = NULL){
        $this->load->view('public/includes/header', $Info);
        $this->load->view('public/' . $viewName, $Info);
        $this->load->view('public/includes/footer', $Info);
    }
